...
Guidelines that include ![ASR & NR] apply to [Notarization for iOS and iPadOS apps in the EU](/support/dma-and-apps-in-the-eu/#notarization-for-ios-apps) and [Notarization for iOS apps in Japan](/support/app-distribution-in-japan/#notarization-for-ios-apps).
...
- **2.5.6** ![ASR & NR] Apps that browse the web must use the appropriate WebKit framework and WebKit JavaScript. You may apply for an entitlement to use an alternative web browser engine in your app. [Learn more about these entitlements](/support/alternative-browser-engines/).
...
Last Updated: [February 6, 2026](/news/?id=d75yllv4)
